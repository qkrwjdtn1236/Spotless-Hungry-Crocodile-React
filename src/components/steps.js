...
Steps.defaultProps = {
  step4Title: 'Publishing and Distribution',
  step1Title: 'Submit Your Manuscript',
  step2Description:
    'Our team will work with you to edit and proofread your manuscript to ensure it meets publishing standards.',
  step4Description:
    'Once the book is finalized, we will publish it in both print and digital formats and distribute it to major retailers.',
  step3Title: 'Design and Layout',
  step2Title: 'Editing and Proofreading',
  step1Description:
    'Send us your completed manuscript for review by our editorial team.',
  step3Description:
    'Our designers will create a visually appealing layout for your book, including cover design and interior formatting.',
}
